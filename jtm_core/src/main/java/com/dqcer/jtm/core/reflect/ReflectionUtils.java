package com.dqcer.jtm.core.reflect;
...
public class ReflectionUtils {
     ...
     * @return 获取的值
     */
    private  Object getOrSet(Object object, String filedName, boolean isGet, Object value)  {
        ...
        if (isGet){
            return  getter(object,fields,filedName);
        }

        setter(object,fields,filedName,value);
        return null;
    }
     ...
     * @param date 要设置的值
     */
    private  void setter(Object entity, List<Field> fields, String fieldName, Object date)  {
        try {
     ...
     * @return 属性的值
     */
    private  Object getter(Object entity, List<Field> fields, String fieldName) {
        try {
            for (int j = 0 ; j < fields.size(); j++) {
                Field field = fields.get(j);
                if (fieldName.equals(field.getName())){
