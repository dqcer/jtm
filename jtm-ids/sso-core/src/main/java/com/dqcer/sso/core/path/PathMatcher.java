package com.dqcer.sso.core.path;
 ...
 *
 * <p>The default implementation is {@link com.dqcer.sso.core.path.impl.AntPathMatcher}, supporting the Ant-style pattern syntax.		(borrowed from spring)
 */
